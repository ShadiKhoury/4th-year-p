...
#command=r'python interpretation.py --train_data "C:\Users\shade\Desktop\עבודות\שנה ד״\פרויקט\VS_project\4th-year-project\Data\train_blood.csv" --test_data "C:\Users\shade\Desktop\עבודות\שנה ד״\פרויקט\VS_project\4th-year-project\Data\test_blood.csv" --train_labels "C:\Users\shade\Desktop\עבודות\שנה ד״\פרויקט\VS_project\4th-year-project\Data\y_train_blood.csv" --test_labels "C:\Users\shade\Desktop\עבודות\שנה ד״\פרויקט\VS_project\4th-year-project\Data\y_test_blood.csv" --model "lgbm_blood" --feature_imprtance_type "All_normilaze"'
os.system(command)
