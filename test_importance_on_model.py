...
plt.plot([0,1],[0,1], 'k--')
plt.plot(fpr1, tpr1, label= "Shap",linewidth=3)
plt.plot(fpr2, tpr2, label= "Lime",linewidth=8,alpha=0.3,color="purple")
plt.plot(fpr3, tpr3, label= "LGBM",linewidth=3)
plt.plot(fpr4, tpr4, label= "Dice",alpha=0.8,linewidth=3,color="green")
plt.legend(loc='best',fontsize = 'xxx-large',prop={'size': 20},facecolor='white',framealpha=0.55,fancybox=True,edgecolor='gray')
